...
storiesOf("Appointment", module)
  ...
  .add("Error", () => <Error massage="Could not delete appointment." onClose={action("onClose")} />)
  .add("Edit", () => <Form student="Mohamed" interviewer={2} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
